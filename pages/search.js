          ...
          <Grid container justifyContent="space-between" alignItems="center">
            ...
            <Grid item>
              ...
              <Select value={sort} onChange={sortHandler}>
                ...
                <MenuItem value="toprated">Customer Review</MenuItem>
                <MenuItem value="newest">Newest Arriavl</MenuItem>
              </Select>
            </Grid>
          </Grid>
...
export async function getServerSideProps({ query }) {
  ...
  // 10-50 ==> price.split('-')[0] = 10 / price.split('-')[1] = 50
  const priceFilter =
    price && price !== 'all'
      ? {
          price: {
